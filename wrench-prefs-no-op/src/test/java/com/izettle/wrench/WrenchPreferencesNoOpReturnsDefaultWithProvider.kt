...
@Config(sdk = [O])
class WrenchPreferencesNoOpReturnsDefaultWithProvider {
    ...
    @Test
    fun `return default enum when provider available`() {
    ...
    @Test
    fun `return default string when provider available`() {
        assertEquals(0, contentProviderController.get().bolts.size)
    ...
    @Test
    fun `return default boolean when provider available`() {
        assertEquals(0, contentProviderController.get().bolts.size)
    ...
    @Test
    fun `return default int when provider available`() {
        assertEquals(0, contentProviderController.get().bolts.size)
